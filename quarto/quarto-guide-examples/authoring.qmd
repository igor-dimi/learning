...
Einsteins's theory of of special relativity that expresses the equivalence
of mass and energy:
...
See @fig-simple in @sec-plot for a demo of a simple plot
...
::: {.callout-note}
Note that ther are five types of callouts, including:
